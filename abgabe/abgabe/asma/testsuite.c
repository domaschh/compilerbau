...
int main()
{
    test("Test0: One word all lowercase 64 long", "abcdefghabcdefghabcdefghabcdefghabcdefghabcdefghabcdefghabcdefgh", 1);
    ...
    printf("=======================Official testcases n================");
    test("Test9: More lowercase than n ", "\x22", 1);
    test("Test9: More lowercase than n ", "@_+[] ~`\xff\x01abcdefghijklmnopqrstuvwxyz{}ABCDEFGHIJK", 49);
}
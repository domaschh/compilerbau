...
.LFB0:    
    .cfi_startproc
    vmovdqu8    .LC0(%rip), %zmm3 # -97 zmm register
    vmovdqu8    .LC1(%rip), %zmm4 # 25 zmm register
...
loop_start:
    ...
    kmovq   %r8, %k1  
    cmpq    $64, %r11 
    jge   skip_shift # wenn groesser als 64 brauch ma mask shift nd
	...
	shrx   	%rdx, %rcx, %rcx
	cmpq $0, %r11
	cmove %r11, %rcx # this is for the testcasse that n is 0 so that we cont do anything at all
	kmovq    %rcx, %k1

skip_shift:
	vmovdqu8   (%rdi, %r10), %zmm9 {%k1}
	vpaddsb	   %zmm9, %zmm3, %zmm1 # all characters minus 97
